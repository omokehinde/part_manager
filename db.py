...
# db.insert("Asos Mobo","Mike Henry","MicroCenter","340")
# db.insert("500w PSU","Karen Dartin","NewAge","70")
# db.insert("2GB Ram","Karen Dartin","NewAge","50")
# db.insert("32 inches monitor","Sam Jones","CashNCarry","400")
# db.insert("NVDIA RTX 3049","Tim Gay","Slot","56")
# db.insert("359w PSU","Karen Dartin","NewAge","55")